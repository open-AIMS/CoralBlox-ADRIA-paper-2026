...
![**Figure S4. Convergence analysis for each DHW range and metric.**](../figures/S04_convergence_analysis.png){width="6.268055555555556in" height="6.268055555555556in"}
  ...
  Growth acceleration parameters ($\mathbf{\zeta}_{\mathbf{l}}^{\mathbf{h}}$,$\mathbf{\zeta}_{\mathbf{l}}^{\mathbf{m}}$ and          3 (Steepness, midpoint and height)                                      +/- 10% of nominal values
  $\mathbf{\zeta}_{\mathbf{l}}^{\mathbf{s}}$)
