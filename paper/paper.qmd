...
To run the model, we used data from the ReefMod-GBR model [@bozecRapidlyClosingWindow2025], freely and openly available at <https://github.com/ymbozec/REEFMOD.7.2_GBR>. This data is available upon request; please send enquiries to y.bozec@uq.edu.au. Further details are available in the calibration code repository referenced above.
